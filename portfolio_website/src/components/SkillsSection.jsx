...
function SkillsSection() {
  return (
    <div className="grid grid-cols-base grid-row-base max-[790px]:flex max-[790px]:flex-col max-[790px]:gap-4 max-[790px]:items-center">
      ...
      <div className=" bg-zinc-500 row-start-2 min-h-[150px] max-[790px]:w-[40%] max-[790px]:min-h-[300px] mr-5"></div>
      <div className="row-start-2 col-start-2 max-[790px]:text-center">
